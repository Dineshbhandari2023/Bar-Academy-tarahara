...
export default function Navbar({
  ...
  const navLinks = [
    ...
    {
      href: "#ai-studio",
      label: lang === "np" ? "AI रेसिपी स्टुडियो" : "AI Recipe Studio",
    },
    {
      href: "#career-advisor",
      label: lang === "np" ? "करियर काउन्सिलर" : "Career Advisor",
    },
    {
      href: "#verify",
      label: lang === "np" ? "प्रमाणपत्र जाँच" : "Verify Certificate",
    },
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <a href="#" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              ...
              <span
                className={`text-[10px] tracking-[0.25em] font-medium uppercase mt-1 ${
          ...
          <div className="hidden sm:flex items-center gap-4">
            {/* Language Switcher */}
            <div
              className={`flex items-center rounded-lg p-1 border text-xs font-semibold ${
                theme === "dark"
